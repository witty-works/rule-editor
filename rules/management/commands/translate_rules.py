...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        #                 "pluralism":"default"
        #             },
        #             "direct_translation": False, #TODO: Maybe direct translation is only part of tranlated rule, as we dont know for en? 
        #             "alternatives":{
        ...
        #             }
        #         },
        #         "example_short_non_direct_en": {
        #         },
        #         "example_short_non_direct_de": {
        #         }    
        #     }
        
        # example_translation_categories = {}
        # rule_formatted_for_translation_category = {}
        for rule in rules:
            if rule.language != "en":
                # self.stdout.write(self.style.ERROR(f"Skipping rule {rule} because it is not in english"))
                continue
            ...
            rule_formatted_for_translation = {
                ...
                "rule_specification":{
                    ...
                    "lemma_type": rule.type, #TODO: nicer name? 
                ...
                "false_positive_examples":{
                    "false_positive_sentence_1": false_positive_sentences[0].text if len(false_positive_sentences) > 0 else "",
                    "false_positive_sentence_2": false_positive_sentences[1].text if len(false_positive_sentences) > 1 else ""
                }
            }
    
            print(rule_formatted_for_translation)
